...
//	alert(megamenu.offsetx+megamenu.anchorwidth);
...
hidemenu:function(e, megamenu_pos){
	...
	var $menuinner=megamenu.$menuinner
	var menutopitem = document.getElementById(megamenu.menutopitem)
	menutopitem.className = megamenu.toplevelclass
...
render:function($){
	for (var i=0, labels=this.megamenulabels[i]; i<this.megamenulabels.length; i++, labels=this.megamenulabels[i]){
		...
		if (megamenu.actualwidth== 0)
		{
			megamenu.actualwidth = megamenu.menuwidth
		}
...
/*		megamenu.$anchorobj.bind("focus", function(e){
			var menuinfo=jkmegamenu.megamenus[parseInt(this.getAttribute("_megamenupos"))]
			clearTimeout(menuinfo.hidetimer) //cancel hide menu timer
			return jkmegamenu.showmenu(e, parseInt(this.getAttribute("_megamenupos")))
		})*/
